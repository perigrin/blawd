...
is( $entries[0]->mtime, DateTime->from_epoch( epoch => $hello->stat->mtime, time_zone => 'America/New_York' ),
    'right mtime' );
...
is( $entries[-1]->mtime, DateTime->from_epoch( epoch => $hello->stat->mtime, time_zone => 'America/New_York' ),
    'right mtime' );
...
is( $entries[0]->mtime, DateTime->from_epoch( epoch => $bye->stat->mtime, time_zone => 'America/New_York' ),
    'right mtime' );
is( $entries[0]->author->name, 'Chris Prather',       'right author' );
